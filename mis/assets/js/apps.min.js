var handleSlimScroll = function () {
    ...
    handleMobileSidebarToggle = function () {
        ...
        return panelActionRunning ? !1 : (panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (e) {
            ...
            e.preventDefault(), $(this).tooltip("destroy"), $(this).closest("[class*=col]").remove()//$(this).closest(".panel").remove()
            ...
            var ap = $(a).hasClass("panel-expand");
            if (ap) {
                $(this).closest('.panel-heading-btn').find('a:gt(0)').removeClass('hide');
                $(a).find('[databack]').removeClass('hide');
            } else {
                $(a).find('[databack]').addClass('hide');
                $(this).closest('.panel-heading-btn').find('a:gt(0)').addClass('hide');
            }

            /*var fc = $(a).hasClass("has_fusion_chart");
            if(fc){
                if(ap){
                    console.log($(a).find('.fusion_chart_div').css('height','310px'))
                }else{
                    console.log($(a).find('.fusion_chart_div').css('height','100%'))
                }
            }else{
            ...
            /**
             * Highcharts window resize after drag
             */
            if (typeof(Highcharts) !== 'undefined') {
                $(Highcharts.charts).each(function (i, chart) {
                    var cht_hei = $(a).hasClass('panel-expand');
                    if (chart != "" && typeof(chart) != "undefined") {
                        if (cht_hei === true) {
                            var height = a[ 0 ].clientHeight - 45;
                            var width = a[ 0 ].clientWidth - 20;
        ...
        $(e).sortable({
            disabled                                             : true,
            handle: a, connectWith: t, cursorAt: {left: 15}, stop: function (e, a) {
        ...
        $(document).scroll(function () {
            ...
            $('body').animate({scrollTop: 40}, 150);
            $('body').animate({scrollTop: 0}, 100);
            $('body').animate({scrollTop: 20}, 100);
            $('body').animate({scrollTop: 0}, 100);
            $('body').animate({scrollTop: 10}, 50);
            $('body').animate({scrollTop: 0}, 100);
            $('body').animate({scrollTop: 5}, 50);
            $('body').animate({scrollTop: 0}, 100);
        })
        ...
        $.cookie && $.cookie("sidebar-minified") && 0 !== $("body").length && "large" == $.cookie("sidebar-minified") && ($("#page-container").addClass("page-sidebar-minified"),
            $('[name=sidebar-minified] option[value="2"]').prop("selected", !0)),

        $.cookie && $.cookie("menu-position") && 0 !== $("body").length && "top" == $.cookie("menu-position") && ($("#page-container").removeClass('page-sidebar-fixed page-sidebar-minified').addClass("page-with-top-menu page-without-sidebar"),
            $('[name=menu-position] option[value="2"]').prop("selected", !0)), ($.cookie("menu-position") == 'top') ? $("[data-ng-click='toggle_sidemunu($event)']").trigger('click') : "",
            ($.cookie("menu-position") == 'top') ? $(".theme-panel [name=sidebar-minified] option:nth-child(2), .theme-panel [name=header-fixed] option:nth-child(2)").prop('disabled', true) : "",
            ($.cookie("menu-position") == 'side') ? $(".theme-panel [name=sidebar-minified] option:nth-child(2), .theme-panel [name=header-fixed] option:nth-child(2)").prop('disabled', false) : "",
            ...
            $(document).on("change", ".theme-panel [name=sidebar-minified]", function () {
                2 == $(this).val() ? ($("#page-container").addClass("page-sidebar-minified"),
                    $.cookie("sidebar-minified", "large")) : ($("#page-container").removeClass("page-sidebar-minified"),
                    $.cookie("sidebar-minified", "minified"))
            }),

            $(document).on("change", ".theme-panel [name=menu-position]", function () {
                2 == $(this).val() ? ($("#page-container").removeClass('page-sidebar-fixed page-sidebar-minified').addClass("page-with-top-menu page-without-sidebar"),
                    $.cookie("menu-position", "top")) : ($("#page-container").removeClass("page-with-top-menu").addClass('page-sidebar-fixed'),
                    $.cookie("menu-position", "side")), $("[data-ng-click='toggle_sidemunu($event)']").trigger('click'), rezisechart(),
                    ($.cookie("menu-position") == 'top') ? $(".theme-panel [name=sidebar-minified] option:nth-child(2), .theme-panel [name=header-fixed] option:nth-child(2)").prop('disabled', true) : "",
                    ($.cookie("menu-position") == 'side') ? $(".theme-panel [name=sidebar-minified] option:nth-child(2), .theme-panel [name=header-fixed] option:nth-child(2)").prop('disabled', false) : "",
                    ($.cookie("sidebar-styling") == 'grid') ? $("#sidebar").addClass('sidebar-grid') : ""
            ...
            $(document).on("change", ".theme-panel [name=sidebar-fixed]", function () {
                1 == $(this).val() ? (2 == $(".theme-panel [name=header-fixed]").val() && (alert("Default Header with Fixed Sidebar option is not supported. Proceed with Fixed Header with Fixed Sidebar."),
                    ...
                    $("#header").addClass("navbar-fixed-top"), $("#page-container").addClass("page-header-fixed")),
            ...
            1 == $(this).val() ? ($("#header").addClass("navbar-fixed-top"),
                ...
                $.cookie("header-fixed", !0)) : (1 == $(".theme-panel [name=sidebar-fixed]").val() && (alert("Default Header with Fixed Sidebar option is not supported. Proceed with Default Header with Default Sidebar."), $('.theme-panel [name=sidebar-fixed] option[value="2"]').prop("selected", !0),
        ...
        $(".page-sidebar-minified .sidebar [data-scrollbar=true] a").bind("touchstart", function (a) {
            ...
            var t = $(this).closest("[data-scrollbar=true]"), i = $(window).height(),
                n = parseInt($("#sidebar").css("padding-top")), o = $("#sidebar").height();
            e = $(t).css("margin-top");
            var s = n;
        ...
        "use strict";
        function e(e, a) {
            var t = $(e).closest(".nav"), i = parseInt($(t).css("margin-left")), n = $(".top-menu").width() - 88, o = 0,
                s = 0;
            switch ($(t).find("li").each(function () {
        ...
        function a() {
            var e = $(".top-menu .nav"), a = $(".top-menu .nav > li"), t = $(".top-menu .nav > li.active"),
                i = $(".top-menu"), n = (parseInt($(e).css("margin-left")), $(i).width() - 128),
                o = $(".top-menu .nav > li.active").width(), s = 0, l = 0;
